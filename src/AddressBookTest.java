...
public class AddressBookTest {
    ...
    public void setUp() {
        ...
        File file = new File(AddressBook.ADDRESS_BOOK_OUTPUT_FILE);
        file.delete();
    ...
    public void testXMLImport(AddressBook addressBook) throws IOException, ParserConfigurationException, SAXException {
    ...
    private void testToXML(AddressBook addressBook)
    {
